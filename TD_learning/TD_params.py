...
SARSA_DISCOUNT_FACTOR = 0.99
SARSA_ALPHA = 0.1
SARSA_EPSILON = 0.1
SARSA_EPISODES = 1000
SARSA_MAX_EPISODE_LENGTH = 200

EXPECTED_SARSA_EPISODES = 500
EXPECTED_SARSA_MAX_EPISODE_LENGTH = 200

SARSA_N_EPISODES = 1000
SARSA_N_STEPS = 1
SARSA_N_MAX_EPISODE_LENGTH = 200
