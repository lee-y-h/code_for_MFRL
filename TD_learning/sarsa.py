...
def main():
    ...
    for _ in range(params.SARSA_EPISODES):
        ...
        while not env.is_target(state_t):
            ...
            Q[state_t][action_t] += params.SARSA_ALPHA * (
                reward + params.SARSA_DISCOUNT_FACTOR * Q[state_t1][action_t1] - Q[state_t][action_t]
            )
    ...
    if params.SHOW_GRID_WORLD:
        ...
        env.render(state_value, most_likely_action, folder_path=str(project_root / "renders" / "sarsa"),
